...
const FALLBACK_LIST = [
  ...
  ['00881','國泰台灣5G+','上市'],['00891','中信關鍵半導體','上市'],['00900','富邦特選高股息30','上市'],
  /* 半導體 */
  ['2330','台積電','上市'],['2303','聯電','上市'],['2454','聯發科','上市'],
  ['3711','日月光投控','上市'],['2344','華邦電','上市'],['3034','聯詠','上市'],
  ['3037','欣興','上市'],['2327','國巨','上市'],['2379','瑞昱','上市'],
  ['2395','研華','上市'],['3008','大立光','上市'],['8046','南電','上市'],
  ['3661','世芯-KY','上市'],['3443','創意','上市'],['6669','緯穎','上市'],
  ['3017','奇鋐','上市'],['2408','南亞科','上市'],['2448','晶電','上市'],
  ['6239','力成','上市'],['4958','臻鼎-KY','上市'],['6770','力積電','上市'],
  /* 電子製造/ODM */
  ['2317','鴻海','上市'],['2382','廣達','上市'],['2357','華碩','上市'],
  ['2308','台達電','上市'],['2356','英業達','上市'],['2376','技嘉','上市'],
  ['2377','微星','上市'],['3231','緯創','上市'],['2385','群光','上市'],
  ['2474','可成','上市'],['6278','台表科','上市'],['2059','川湖','上市'],
  ['2353','宏碁','上市'],['2301','光寶科','上市'],['2360','致茂','上市'],
  ['2404','漢唐','上市'],['2409','友達','上市'],['2412','中華電','上市'],
  ['2498','宏達電','上市'],['3045','台灣大','上市'],['4904','遠傳','上市'],
  ['2371','大同','上市'],['6446','藥華藥','上市'],
  /* 金融 */
  ['2891','中信金','上市'],['2882','國泰金','上市'],['2881','富邦金','上市'],
  ['2884','玉山金','上市'],['2886','兆豐金','上市'],['2892','第一金','上市'],
  ['2880','華南金','上市'],['2885','元大金','上市'],['2887','台新金','上市'],
  ['2890','永豐金','上市'],['5880','合庫金','上市'],['2345','智邦','上市'],
  ['2883','開發金','上市'],['2888','新光金','上市'],['6005','群益證','上市'],
  /* 傳產/民生 */
  ['1301','台塑','上市'],['1303','南亞','上市'],['1326','台化','上市'],
  ['6505','台塑化','上市'],['2002','中鋼','上市'],['1101','台泥','上市'],
  ['1102','亞泥','上市'],['1216','統一','上市'],['2912','統一超','上市'],
  ['2207','和泰車','上市'],['1402','遠東新','上市'],['1210','大成','上市'],
  /* 航運 */
  ['2603','長榮','上市'],['2609','陽明','上市'],['2615','萬海','上市'],
  ['2610','華航','上市'],['2618','長榮航','上市'],
  /* 上櫃 */
  ['8299','群聯','上櫃'],['5274','信驊','上櫃'],['6488','環球晶','上櫃'],
  ['3293','鈊象','上櫃'],['5483','中美晶','上櫃'],['3035','智原','上櫃'],
  ['5269','祥碩','上櫃'],['6415','矽力-KY','上櫃'],['3044','健鼎','上櫃'],
  ['4966','譜瑞-KY','上櫃'],['3533','嘉澤','上櫃'],['6462','神盾','上櫃'],
  ['8069','元太','上市'],['1590','亞德客-KY','上市'],['6669','緯穎','上市'],
];
...
async function loadStockList(){
  ...
  stockListReady=true;
  window.dispatchEvent(new CustomEvent('stocklistready'));
}
...
function wireSearchBox(opts){
  ...
  /* Re-run search when live stock list arrives (handles slow/deferred loads) */
  window.addEventListener('stocklistready', ()=>{
    const q = input.value.trim();
    if(q && !box.hidden) renderSuggest(searchStocks(normalize(q.split(/\s+/)[0])||normalize(q)));
  }, {once: true});
}
